...
!function(t, e) {
    ...
    function za(t, e) {
        ...
        (!e._dur || gt(0, e.totalDuration(), r) - e._tTime > R) && e.render(r, !0)),
    ...
    var E, i, a, h, l, f, d, c, m, g, v, y, T, b, w, x, k, C, A, P, S, D, F, U = {
        ...
        overwrite: !1,
        delay: 0
    }, z = 1e8, R = 1 / z, B = 2 * Math.PI, X = B / 4, V = 0, j = Math.sqrt, G = Math.cos, Q = Math.sin, J = Array.isArray, W = /(?:-?\.?\d|\.)+/gi, H = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g, tt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, et = /[-+=.]*\d+(?:\.|e-|e)*\d*/gi, rt = /\(([^()]+)\)/i, it = /[+-]=-?[\.\d]+/, nt = /[#\-+.]*\b[a-z\d-=+%.]+/gi, at = {}, st = {}, ot = [], ut = {}, ht = {}, lt = {}, ft = 30, dt = [], ct = "", pt = function _merge(t, e) {
        for (var r in e)
            t[r] = e[r];
        return t
    ...
    zt.totalTime = function totalTime(t, e) {
        ...
        return (this._tTime !== t || !this._dur && !e || this._initted && Math.abs(this._zTime) === R || !t && !this._initted) && (this._ts || (this._pTime = t),
        ea(this, t, e)),
        this
    }
    ,
    ...
    zt.paused = function paused(t) {
        ...
        this._ts = this._rts,
        this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= R) && Math.abs(this._zTime) !== R))),
        this) : this._ps
    }
    ,
    ...
    zt.reversed = function reversed(t) {
        return arguments.length ? (!!t !== this.reversed() && this.timeScale(-this._rts || (t ? -R : 0)),
        this) : this._rts < 0
    }
    ,
    ...
    var Rt = function(i) {
        ...
        t.render = function render(t, e, r) {
            var i, n, a, s, o, u, h, l, f, d, c, p, _ = this._time, m = this._dirty ? this.totalDuration() : this._tDur, g = this._dur, v = this !== E && m - R < t && 0 <= t ? m : t < R ? 0 : t, y = this._zTime < 0 != t < 0 && (this._initted || !g);
        ...
        t.totalDuration = function totalDuration(t) {
            ...
            if (s._dirty) {
                for (n = s.parent; o; )
                    ...
                    a < (r = xa(o)) && o._ts && (a = r),
                    o = e;
                Fa(s, s === E && s._time > a ? s._time : a, 1),
                s._dirty = 0
            }
            return s._tDur
        }
    ...
    var Lt, Bt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
        o(i) && (i = i(a || 0, t, s));
        var f, d = t[e], c = "get" !== r ? r : o(d) ? l ? t[e.indexOf("set") || !o(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](l) : t[e]() : d, p = o(d) ? l ? jt : Vt : Zt;
        if (n(i) && (~i.indexOf("random(") && (i = ab(i)),
        "=" === i.charAt(1) && (i = parseFloat(c) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (La(c) || 0))),
        c !== i)
            ...
            .call(this, t, e, c, i, p, h || U.stringFilter, l)) : (f = new ee(this._pt,t,e,+c || 0,i - (c || 0),"boolean" == typeof d ? Jt : Qt,0,p),
            l && (f.fp = l),
            u && f.modifier(u, this, t),
            this._pt = f)
    }, qt = function _initTween(t, e) {
        var r, i, n, a, o, u, h, l, f, d, c, p, _ = t.vars, m = _.ease, g = _.startAt, v = _.immediateRender, y = _.lazy, T = _.onUpdate, b = _.onUpdateParams, w = _.callbackScope, x = _.runBackwards, k = _.yoyoEase, O = _.keyframes, M = _.autoRevert, C = t._dur, A = t._startAt, P = t._targets, S = t.parent, D = S && "nested" === S.data ? S.parent._targets : P, F = "auto" === t._overwrite, z = t.timeline;
        if (!z || O && m || (m = "none"),
        t._ease = Ft(m, I.ease),
        ...
        t._ease = k),
        !z) {
            if (p = (l = P[0] ? Z(P[0]).harness : 0) && _[l.prop],
            r = la(_, st),
            A && A.render(-1, !0).kill(),
            g) {
                ...
                v) {
                    ...
                    _initTween(t._startAt, R);
            for (t._pt = 0,
            y = C && s(y) || y && !C,
            i = 0; i < P.length; i++) {
                if (h = (o = P[i])._gsap || Y(P)[i]._gsap,
                t._ptLookup[i] = d = {},
                ut[h.id] && da(),
                c = D === P ? i : D.indexOf(o),
                ...
                !l || p)
                    for (n in r)
                        ht[n] && (f = Mb(n, r, t, c, o, D)) ? f.priority && (u = 1) : d[n] = a = Bt.call(t, o, n, "get", r[n], c, D, 0, _.stringFilter);
    ...
    }, Nt = ct + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Ut = (Nt + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Xt = function(D) {
        function Tween(t, e, i, n) {
            ...
            }(_assertThisInitialized(a)) && "nested" !== P.data) && (a._tTime = -R,
        ...
        return t.render = function render(t, e, r) {
            var i, n, a, s, o, u, h, l, f, d = this._time, c = this._tDur, p = this._dur, _ = c - R < t && 0 <= t ? c : t < R ? 0 : t;
            if (p) {
                if (_ !== this._tTime || !t || r || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    n = this._pt; n; )
                        n.r(h, n.d),
                        n = n._next;
                    l && l.render(t < 0 ? t : !i && u ? -R : l._dur * h, e, r) || this._startAt && (this._zTime = t),
                ...
                !function _renderZeroDurationTween(t, e, r, i) {
                    var n, a, s = t.ratio, o = e < 0 || !e && s && !t._start && t._zTime > R && !t._dp._lock || t._ts < 0 || t._dp._ts < 0 ? 0 : 1, u = t._rDelay, h = 0;
            ...
            l = f.length; l--; )
                if (~d.indexOf(f[l]))
                    ...
                    o)
                        ...
                        delete a[u]),
                        "all" !== s && (s[u] = 1);
            return this._initted && !this._pt && p && fb(this),
            this
        }
        ,
    ...
    var re = {
        ...
        defaults: function defaults(t) {
            return t && t.ease && (t.ease = Ft(t.ease, I.ease)),
            ka(I, t || {})
        },
    ...
    Xt.version = Rt.version = ie.version = "3.4.0",
    f = 1,
    t() && Ct();
    function Uc(t, e) {
    ...
    function td(t, e, r, i) {
        var n, a, s, o, u = parseFloat(r) || 0, h = (r + "").trim().substr((u + "").length) || "px", l = ue.style, f = Ie.test(e), d = "svg" === t.tagName.toLowerCase(), c = (d ? "client" : "offset") + (f ? "Width" : "Height"), p = "px" === i, _ = "%" === i;
        return i === h || !u || Ue[i] || Ue[h] ? u : ("px" === h || p || (u = td(t, e, r, "px")),
        o = t.getCTM && pd(t),
    ...
    function Fd(t, e, r, i, n, a) {
        var s, o, u, h = t._gsap, l = n || Ed(t, !0), f = h.xOrigin || 0, d = h.yOrigin || 0, c = h.xOffset || 0, p = h.yOffset || 0, _ = l[0], m = l[1], g = l[2], v = l[3], y = l[4], T = l[5], b = e.split(" "), w = parseFloat(b[0]) || 0, x = parseFloat(b[1]) || 0;
    ...
    var ne, ae, se, oe, ue, he, le, fe, de = At.Power0, ce = At.Power1, pe = At.Power2, _e = At.Power3, me = At.Power4, ge = At.Linear, ve = At.Quad, ye = At.Cubic, Te = At.Quart, be = At.Quint, we = At.Strong, xe = At.Elastic, ke = At.Back, Oe = At.SteppedEase, Me = At.Bounce, Ce = At.Sine, Ae = At.Expo, Pe = At.Circ, Se = {}, De = 180 / Math.PI, Fe = Math.PI / 180, ze = Math.atan2, Ee = /([A-Z])/g, Ie = /(?:left|right|width|margin|padding|x)/i, Re = /[\s,\(]\S/, Le = {
        ...
        if ("x"in r && !e && !r.uncache)
            return r;
        var i, n, a, s, o, u, h, l, f, d, c, p, _, m, g, v, y, T, b, w, x, k, O, M, C, A, P, S, D, F, z, E, I = t.style, R = r.scaleX < 0, L = "deg", B = id(t, qe) || "0";
                ...
                !ht[f] || !Mb(f, e, r, i, t, n)))
                    ...
                    l)
                        ...
                        _ = f in Se)
                            ...
                            "scale" === f)
                                ...
                                if ("transformOrigin" === f) {
                                    s = xd(s),
                                    g.svg ? Fd(t, s, 0, v, 0, this) : ((c = parseFloat(s.split(" ")[2]) || 0) !== g.zOrigin && rd(this, g, "zOrigin", g.zOrigin, c),
                        ...
                        if (_ || (o || 0 === o) && (u || 0 === u) && !Re.test(s) && f in b)
                            (d = (a + "").substr((u + "").length)) !== (c = (s + "").substr(((o = o || 0) + "").length) || (f in U.units ? U.units[f] : d)) && (u = td(t, f, a, c)),
                            this._pt = new ee(this._pt,_ ? g : b,f,u,p ? p * o : o - u,"px" !== c || !1 === e.autoRound || _ ? Uc : Xc),
                            this._pt.u = c || 0,
                            d !== c && (this._pt.b = a,
                            this._pt.r = Wc);
                        else if (f in b)
